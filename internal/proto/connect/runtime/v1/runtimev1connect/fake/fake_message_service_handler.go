...
type FakeMessageServiceHandler struct {
...
func (fake *FakeMessageServiceHandler) PushMessage(arg1 context.Context, arg2 *connect.Request[PushMessageRequest]) (*connect.Response[PushMessageResponse], error) {
...
func (fake *FakeMessageServiceHandler) PushMessageCallCount() int {
	fake.pushMessageMutex.RLock()
	defer fake.pushMessageMutex.RUnlock()
	return len(fake.pushMessageArgsForCall)
}

func (fake *FakeMessageServiceHandler) PushMessageCalls(stub func(context.Context, *connect.Request[PushMessageRequest]) (*connect.Response[PushMessageResponse], error)) {
	fake.pushMessageMutex.Lock()
	defer fake.pushMessageMutex.Unlock()
	fake.PushMessageStub = stub
}

func (fake *FakeMessageServiceHandler) PushMessageArgsForCall(i int) (context.Context, *connect.Request[PushMessageRequest]) {
	fake.pushMessageMutex.RLock()
	defer fake.pushMessageMutex.RUnlock()
...
func (fake *FakeMessageServiceHandler) PushMessageReturns(result1 *connect.Response[PushMessageResponse], result2 error) {
	fake.pushMessageMutex.Lock()
	defer fake.pushMessageMutex.Unlock()
...
func (fake *FakeMessageServiceHandler) PushMessageReturnsOnCall(i int, result1 *connect.Response[PushMessageResponse], result2 error) {
	fake.pushMessageMutex.Lock()
	defer fake.pushMessageMutex.Unlock()
	fake.PushMessageStub = nil
...
func (fake *FakeMessageServiceHandler) Invocations() map[string][][]interface{} {
...
func (fake *FakeMessageServiceHandler) recordInvocation(key string, args []interface{}) {
...
var _ runtimev1connect.MessageServiceHandler = new(FakeMessageServiceHandler)
